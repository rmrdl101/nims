    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('dashboard/admin/departments') }}",
                columns: [
                        @if(in_array($read||$update||$delete, $permArray))
            ...
            $('#new-data').click(function () {
                ...
                $('#crudModal').html("Add New Department");
                /* slug generator */
                $('#name').keyup(function() {
                    var str = $('#name').val();
            ...
            $('#add-form').on('submit', function (e) {
                ...
                var edit = $('#edit').val();
                if(item_id == 0){
                    var url = "{{ url('dashboard/admin/departments') }}/" + edit;

                }else if (item_id ==1){
                    var url = "{{ url('dashboard/admin/departments') }}";
                }
            ...
            $('body').on('click', '#edit-data', function () {
                ...
                $.get('departments/'+item_id+'/edit', function (data) {
